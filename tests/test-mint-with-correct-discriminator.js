...
const PROGRAM_ID = new PublicKey('H39bbzuL3aYxCATxRtzwjitGJ2SiTxYtBB8yyoRt92YC');
const TOKEN_METADATA_PROGRAM_ID = new PublicKey('metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s');

async function testMintNFT() {
  console.log('🧪 Testing NFT mint with correct discriminator...');
  ...
  console.log('Expected Program State PDA:', programStatePda.toString());
  ...
  // Create instruction data with correct discriminator for mintNft
  const discriminator = Buffer.from('ec737ad5f7d3f325', 'hex');
  const name = 'Test NFT';
  const symbol = 'TEST';
...
testMintNFT().catch(console.error);